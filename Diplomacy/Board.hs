...
giveOrder
  :: Order phaseType
  -> Board phaseType
  -> (OrderValidation phaseType, Board phaseType)
giveOrder order board = (orderValidation, nextBoard)
  where
    orderValidation = validateOrder board order
    nextBoard = case orderValidation of
